...
import lorentz_math as math
from lorentz_utils import acosh

''' url: https://github.com/Graph-and-Geometric-Learning/hyperbolic-transformer/blob/master/Hypformer/manifolds/lorentz.py'''
...
class Lorentz(LorentzOri):
    ...
    def klein_to_lorentz(self, x: torch.Tensor, *, dim=-1) -> torch.Tensor:
        ...
        denominator = torch.sqrt(1 - u_norm_sq).clamp_min(1e-7)
