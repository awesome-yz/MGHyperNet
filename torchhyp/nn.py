...
import torchhyp.pmath as pmath
...
class ToPoincare(nn.Module):
    ...
    def __init__(self, c, train_c=False, train_x=False, ball_dim=None, riemannian=True, clip_emb=False, r=1.0):
        ...
        # clip euclidean embedding
        self.clip_emb = clip_emb
        self.r = r #r hyperparameter for clipping
    ...
    def forward(self, x):
        if self.clip_emb:
            x = pmath.clip_euclidean_embedding(x,self.r)
